...
class DataAugmentor(object):
    ...
    def pa_aug(self, data_dict=None, config=None):
        ...
        pa_aug_ = PartAwareAugmentation(
            data_dict['points'], data_dict['gt_boxes'],data_dict['gt_names'], class_names=['Car']
        )
        points, gt_boxes_mask = pa_aug_.augment(pa_aug_param=config['PARAM'])
