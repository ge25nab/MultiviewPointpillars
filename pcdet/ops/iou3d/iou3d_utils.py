...
def points_in_boxes_cpu(points, boxes):
    ...
    iou3d_cuda.points_in_boxes_cpu(boxes.float().contiguous(), points.float().contiguous(), point_indices)
...
def points_in_boxes_gpu(points, boxes):
    ...
    iou3d_cuda.points_in_boxes_gpu(boxes.contiguous(), points.contiguous(), box_idxs_of_pts)
